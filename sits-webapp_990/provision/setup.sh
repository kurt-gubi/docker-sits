...
ZIP_SITS=${DIR_PROVISION}/990-REL01ZIP.zip
ZIP_UNIFACE=${DIR_PROVISION}/990-REL01LID.zip
...
unzip -qn ${ZIP_UNIFACE} 'uniface990lid.tar.gz' -d ${DIR_PROVISION}/uniface
tar --strip-components=1 -xzf ${DIR_PROVISION}/uniface/uniface990lid.tar.gz -C ${DIR_PROVISION}/uniface
