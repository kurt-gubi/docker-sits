...
ZIP_ALLFIXES="/tmp/provision/990-ALLFIXES.zip"
...
tar --strip-components=1 -xzf ${DIR_TEMP}/uniface/uniface990lid.tar.gz -C ${DIR_APP}/uniface

# Extract SITS
unzip -qn ${ZIP_SITS} 'sits990.zip' -d ${DIR_TEMP}
unzip -qn ${DIR_TEMP}/sits990.zip 'release/9.9.0/sits/*' -d ${DIR_TEMP}/sits
mv ${DIR_TEMP}/sits/release/9.9.0/sits ${DIR_APP}/sits
...
rpm -ivh ${DIR_PROVISION}/oracle-instantclient12.2-basic-12.2.0.1.0-1.x86_64.rpm
rpm -ivh ${DIR_PROVISION}/oracle-instantclient12.2-sqlplus-12.2.0.1.0-1.x86_64.rpm
